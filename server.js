...
app.get("/article", async (req, res) => {
  ...
  const article = `
    ...
    <div>    
      ...
      <p>
        Pada usia 40 tahun, saat Muhammad berada di gua Hira untuk menghindari keramaian, dia menerima wahyu pertamanya. Malaikat Jibril muncul di depannya dan menyuruhnya membaca. Muhammad awalnya sangat bingung dan ketakutan oleh pengalaman ini, tetapi istrinya, Khadijah, memberinya dukungan. Ini adalah permulaan kenabian Muhammad, dan wahyu-wahyu selanjutnya yang dia terima dari Allah disusun menjadi Al-Quran, kitab suci umat Islam.</p>
